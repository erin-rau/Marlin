...
#define STRING_CONFIG_H_AUTHOR "Ender3V2 Sprite Pro" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  54.11
  #define DEFAULT_bedKi   3.47
  #define DEFAULT_bedKd 305.01
 ...
 */
#define NUM_SERVOS 1 // CR Touch uses servo index 0; limiting to one channel saves RAM.
